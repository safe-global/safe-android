...
package pm.gnosis.android.app.authenticator.util.zxing;
 ...
 * <p>
 * <p>To integrate, create an instance of {@code ZxingIntentIntegrator} and call {@link #initiateScan()} and wait
 ...
 *   IntentResult scanResult = ZxingIntentIntegrator.parseActivityResult(requestCode, resultCode, intent);
 *   if (scanResult != null) {
 *     // handle scan result
 *   }
 ...
 * <p>
 * <pre>{@code
 * ZxingIntentIntegrator integrator = new ZxingIntentIntegrator(yourActivity);
...
public class ZxingIntentIntegrator {
     ...
     */
    public ZxingIntentIntegrator(Activity activity) {
     ...
     *                 of an {@link Activity}
     */
    public ZxingIntentIntegrator(Fragment fragment) {
