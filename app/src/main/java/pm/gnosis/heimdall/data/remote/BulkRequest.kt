...
open class BulkRequest(vararg calls: Call<out Any?>) {

    private val callMap = HashMap<Int, Call<out Any?>>()
    ...
    class Call<D>(val params: JsonRpcRequest, private val adapter: (JsonRpcResult) -> D) {
        var value: D? = null
