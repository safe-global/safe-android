...
class SimpleEthereumJsonRpcRepository @Inject constructor(
    ...
    class TransactionParametersRequest(
        val estimatedGas: SubRequest<BigInteger>,
        val gasPrice: SubRequest<BigInteger>,
        val transactionCount: SubRequest<BigInteger>
    ) :
        ...
        val request = TransactionParametersRequest(
            ...
            SubRequest(
                JsonRpcRequest(
                    ...
                    params = arrayListOf(fromString, EthereumJsonRpcRepository.DEFAULT_BLOCK_LATEST)
                ), { it.checkedResult().hexAsBigInteger() })
        )
