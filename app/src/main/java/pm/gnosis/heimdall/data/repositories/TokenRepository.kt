...
interface TokenRepository {
    ...
    fun loadTokenBalance(ofAddress: BigInteger, contractAddress: BigInteger): Observable<BigInteger>
    fun loadTokensBalance(ofAddress: BigInteger, erC20Tokens: List<ERC20Token>): Observable<List<Pair<ERC20Token, BigInteger?>>>
