...
class PairingViewModel @Inject constructor(
    ...
    override fun pair(payload: String, signingSafe: Solidity.Address?): Single<Pair<AccountsRepository.SafeOwner, Solidity.Address>> =
        parseChromeExtensionPayload(payload)
            .flatMap { pushServiceRepository.pair(it, signingSafe) }
