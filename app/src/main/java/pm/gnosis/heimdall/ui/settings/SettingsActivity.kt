...
class SettingsActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        layout_settings_toolbar.setTitle(R.string.settings)
        layout_settings_toolbar.setNavigationOnClickListener {
            onBackPressed()
        }
    ...
    private fun setupRpcInput(url: String) {
        layout_settings_rpc_input.setText(url)
        disposables += layout_settings_rpc_input.textChanges()
                .skipInitialValue()
                .debounce(TIMEOUT, TIMEOUT_UNIT)
                .flatMapSingle {
    ...
    private fun setupIpfsInput(url: String) {
        layout_settings_ipfs_input.setText(url)
        disposables += layout_settings_ipfs_input.textChanges()
                .skipInitialValue()
                .debounce(TIMEOUT, TIMEOUT_UNIT)
                .flatMapSingle {
