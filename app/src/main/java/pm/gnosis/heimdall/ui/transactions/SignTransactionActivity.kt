...
class SignTransactionActivity : ViewTransactionActivity() {
    ...
    private val signTransformer: ObservableTransformer<Pair<Solidity.Address?, Result<SafeTransaction>>, *> =
    ...
    private fun signTransaction(safe: Solidity.Address, transaction: SafeTransaction) =
    ...
    companion object {
        ...
        fun createIntent(context: Context, safeAddress: Solidity.Address?, transaction: SafeTransaction, sendViaPush: Boolean = false) =
