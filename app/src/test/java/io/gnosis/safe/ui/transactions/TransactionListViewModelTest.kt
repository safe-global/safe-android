...
class TransactionListViewModelTest {
    ...
    companion object {
        private val ERC20_SERVICE_TOKEN_INFO_NO_SYMBOL = ServiceTokenInfo(TokenRepository.ZERO_ADDRESS, 0, "", "ERC20", "local::ethereum", ServiceTokenInfo.TokenType.ERC20)
        private val ERC721_SERVICE_TOKEN_INFO_NO_SYMBOL = ServiceTokenInfo(Solidity.Address(BigInteger.ZERO), 0, "", "", "local::ethereum", ServiceTokenInfo.TokenType.ERC721)
    }
}
