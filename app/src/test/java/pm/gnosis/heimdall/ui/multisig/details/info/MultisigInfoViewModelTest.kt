...
class MultisigInfoViewModelTest {
    ...
    private fun callSetupAndCheck(address: String, info: MultisigWalletInfo,
        ...
        Mockito.verify(repository, Mockito.times(totalInvocations)).loadMultisigWalletInfo(anyString())
    }

    @Test
    fun setupViewModelClearCache() {
        val address1 = "0xtest1"
    ...
    fun loadMultisigInfoError() {
        ...
        given(repository.loadMultisigWalletInfo(ArgumentMatchers.anyString())).willReturn(Observable.error(exception))
