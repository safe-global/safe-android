...
import pm.gnosis.heimdall.ui.transactions.details.GenericTransactionDetailsContract.CombinedRawInput
import pm.gnosis.heimdall.ui.transactions.details.GenericTransactionDetailsFragment.TransactionInputException.Companion.DATA_FIELD
import pm.gnosis.heimdall.ui.transactions.details.GenericTransactionDetailsFragment.TransactionInputException.Companion.TO_FIELD
import pm.gnosis.heimdall.ui.transactions.details.GenericTransactionDetailsFragment.TransactionInputException.Companion.VALUE_FIELD
...
class GenericTransactionDetailsViewModelTest {
    ...
    fun inputTransformerWithOriginalTransaction() {
        ...
        testTransformer(testPublisher, testObserver,
                CombinedRawInput("0x0" to true, "123" to false, "" to false),
        ...
        testTransformer(testPublisher, testObserver,
                CombinedRawInput("0x0s" to false, "123x" to false, "üp" to false),
                ErrorResult(GenericTransactionDetailsFragment.TransactionInputException(
        ...
        // First changed
        testTransformer(testPublisher, testObserver,
                CombinedRawInput("0x0t" to false, "123x" to true, "üp" to false),
                ErrorResult(GenericTransactionDetailsFragment.TransactionInputException(
                        mockContext, TO_FIELD or VALUE_FIELD or DATA_FIELD, true
                )),
                testNo++
        ...
        // Second changed
        testTransformer(testPublisher, testObserver,
                CombinedRawInput("0x0t" to false, "123y" to false, "üp" to true),
                ErrorResult(GenericTransactionDetailsFragment.TransactionInputException(
                        mockContext, TO_FIELD or VALUE_FIELD or DATA_FIELD, true
                )),
                testNo++
        ...
        // Third changed
        testTransformer(testPublisher, testObserver,
                CombinedRawInput("0x0t" to false, "123y" to false, "öp" to true),
                ErrorResult(GenericTransactionDetailsFragment.TransactionInputException(
                        mockContext, TO_FIELD or VALUE_FIELD or DATA_FIELD, true
                )),
                testNo++
    ...
    fun inputTransformerWithoutOriginalTransaction() {
        ...
        var testNo = 1
        // Valid input with change
        testPublisher.onNext(CombinedRawInput("0x0" to true, "123" to false, "" to false))
