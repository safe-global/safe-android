...
class KeyPairTest {
    ...
    private fun checkKeyPair(keyPair: KeyPair) {
        ...
        assertEquals(
            "pub:02e3c64e2b1d86045297da6167c1b6f26bbdb0ab572728bf3d6722f87e5f0a4838 priv:75205699e5fab1e0fa5c3d41898d00f8d251dc38f09ab85b9f5f035f72725310",
            keyPair.toStringWithPrivate()
        )
    }
    ...
    fun signAndRecover() {
        ...
        val signatureBase64 =
            Base64.toBase64String(byteArrayOf(actualSignature.v) + actualSignature.r.toByteArray() + actualSignature.s.toByteArray())
