...
//            RuntimeException("init").printStackTrace()
    ...
    override fun equals(o: Any?): Boolean {
        ...
        if (o == null || o !is CheckedKeyPair) return false

        val ecKey = o as CheckedKeyPair?
    ...
    companion object {
         ...
         */
        fun fromPrivate(privKey: BigInteger): CheckedKeyPair {
            return CheckedKeyPair(privKey, compressPoint(SECP256K1.g.multiply(privKey)))
        }
         ...
         */
        fun fromPrivate(privKeyBytes: ByteArray): CheckedKeyPair {
         ...
         */
        fun fromPrivateAndPrecalculatedPublic(priv: BigInteger, pub: ECPoint): CheckedKeyPair {
            return CheckedKeyPair(priv, pub)
        }
         ...
         */
        fun fromPrivateAndPrecalculatedPublic(priv: ByteArray?, pub: ByteArray?): CheckedKeyPair {
            check(priv != null, "Private key must not be null")
            check(pub != null, "Public key must not be null")
            return CheckedKeyPair(BigInteger(1, priv), SECP256K1.curve.decodePoint(pub!!))
        }
         ...
         */
        fun fromPublicOnly(pub: ECPoint): CheckedKeyPair {
            return CheckedKeyPair(null, pub)
        }
         ...
         */
        fun fromPublicOnly(pub: ByteArray): CheckedKeyPair {
            return CheckedKeyPair(null, SECP256K1.curve.decodePoint(pub))
        }
        ...
        fun signatureToKey(messageHash: ByteArray, signatureBase64: String): CheckedKeyPair {
         ...
         */
        @Throws(SignatureException::class)
        fun signatureToKey(messageHash: ByteArray, v: Byte, r: BigInteger, s: BigInteger): CheckedKeyPair {
         ...
         */
        fun recoverFromSignature(recId: Int, sig: ECDSASignature, messageHash: ByteArray?): CheckedKeyPair? {
