...
class TokenRepository(
    ...
    companion object {
        ...
        val ERC20_FALLBACK_SERVICE_TOKEN_INFO = ServiceTokenInfo(ZERO_ADDRESS, 0, "ERC20", "ERC20", "local::ethereum")
        val ERC721_FALLBACK_SERVICE_TOKEN_INFO = ServiceTokenInfo(Solidity.Address(BigInteger.ZERO), 0, "NFT", "", "local::ethereum")
    }
}
