...
class DataMoshiTest {
            ...
            txInfo = TransactionInfo.SettingsChange(
                dataDecoded = DataDecoded(
                    ...
                    parameters = listOf(
                        ...
                        Param.ValueParam(name = "_threshold", value = "1", type = "uint256")
                    )
                ),
    ...
    fun `fromJson (param list) - should map to correct param types`() {
        ...
        assertTrue(params[0] is Param.AddressParam)
        ...
        assertTrue(params[1] is Param.AddressParam)
